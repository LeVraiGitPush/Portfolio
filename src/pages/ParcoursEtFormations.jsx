      ...
      <div style={{ display: 'flex', flexWrap: 'wrap-reverse', gap: '2rem', marginBottom: '3rem' }}>
        <div style={{ flex: '2 1 300px' }}>
          ...
          <p>
            ...
            des boutiques en dropshipping et en e-commerce. Ces expériences m'ont permis de 
            développer des compétences concrètes en création de contenu, marketing digital, 
            gestion de projet et vente en ligne.
            En parallèle, j’ai mené plusieurs projets liés à l’IA, notamment le développement d’un 
            SaaS utilisant différents modèles de langage (GPT-4, Claude, Mistral, Llama).
            Cela m’a permis de progresser en programmation (Python, JSX, TSX, APIs), en prompt engineering
            (optimisation, bonnes pratiques) et en création narrative (dialogues, quêtes).
            ...
            de Paris à la Suisse, où j’ai eu l’occasion de manager des équipes.
            Ce travail demande rigueur, organisation, résilience et une bonne résistance au stress.
          </p>
        </div>
        <div style={{ flex: '1 1 300px', maxWidth: '400px' }}>
          <Slider {...sliderSettings}>
